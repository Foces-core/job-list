...
export default function About() {
    return (
        ...
        <meta name="viewport" content="initial-scale=1.0, width=device-width" />
            ...
            <Navbar />
            {/* First Card */}
            <div className="card card-side bg-base-100 m-20 justify-between items-center rounded-none">
            <div className="w-1/3 ">
              <h1 className="text-left mb-8 text-2xl font-bold text-blue-500 md:text-black md:text-4xl">About Scholarfox</h1>
